...
- (void)viewDidLoad
{
    ...
    data = @[
             ...
             @{kHACPercentage:@400,  kHACColor  : [UIColor colorWithRed:0.431f green:0.000f blue:0.533f alpha:1.0f], kHACCustomText : @"February"},
             @{kHACPercentage:@800,  kHACColor  : [UIColor colorWithRed:0.922f green:0.000f blue:0.000f alpha:.75f], kHACCustomText : @"March"},
             @{kHACPercentage:@100,  kHACColor  : [UIColor colorWithRed:0.000f green:0.671f blue:0.180f alpha:.75f], kHACCustomText : @"April"},
             @{kHACPercentage:@600,  kHACColor  : [UIColor colorWithRed:1.000f green:0.000f blue:0.851f alpha:.75f], kHACCustomText : @"May"},
             @{kHACPercentage:@900,  kHACColor  : [UIColor colorWithRed:1.000f green:0.808f blue:0.000f alpha:.75f], kHACCustomText : @"June"},
             @{kHACPercentage:@375,  kHACColor  : [UIColor colorWithRed:0.294f green:0.843f blue:0.251f alpha:.75f], kHACCustomText : @"July"},
             @{kHACPercentage:@300,  kHACColor  : [UIColor colorWithRed:1.000f green:0.404f blue:0.000f alpha:.75f], kHACCustomText : @"August"},
             @{kHACPercentage:@700,  kHACColor  : [UIColor colorWithRed:0.282f green:0.631f blue:0.620f alpha:.75f], kHACCustomText : @"September"},
             @{kHACPercentage:@125,  kHACColor  : [UIColor colorWithRed:0.776f green:0.000f blue:0.702f alpha:.75f], kHACCustomText : @"October"},
             @{kHACPercentage:@50,   kHACColor  : [UIColor colorWithRed:0.282f green:0.631f blue:0.620f alpha:.75f], kHACCustomText : @"November"},
             @{kHACPercentage:@250,   kHACColor  : [UIColor colorWithRed:0.776f green:0.000f blue:0.702f alpha:.75f], kHACCustomText : @"December"}
             ];
